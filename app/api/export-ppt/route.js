...
export async function POST(request) {
  try {
    ...
    slide1.addText(`Question: ${question}`, {
      x: 0.5,
      y: 0.5,
      w: 9,
      h: 1,
    ...
    slide2.addText(`Director Analysis: ${question}`, {
      x: 0.5,
      y: 0.5,
      w: 9,
      h: 1,
    ...
    return new NextResponse(buffer, {
      headers: {
        ...
        'Content-Disposition': `attachment; filename="retrospective-analysis-${question.substring(0, 30)}.pptx"`
      }
    })
