            ...
            <div className="bg-white px-6 py-8 rounded-lg shadow-md">
              <div className="text-center">
                <p className="text-sm text-gray-600 mb-6">
                  Access your retrospective analysis dashboard by signing in with your Google account.
                </p>
                ...
                <div className="mt-4 text-xs text-gray-500">
                  <p>
                    By signing in, you agree to access the retrospective analysis dashboard. 
                    Only authorized users can view survey data.
                  </p>
                </div>
              </div>
            </div>
